...
/**
 * abstract class that receives animal messages
 */
public abstract class ReceiverAnimal extends Consumer {

    private String[] routingKeys;

    public ReceiverAnimal(String[] routingKeys) {
    ...
    public void receive() throws IOException {
        ...
        for (String key : routingKeys) {
            channel.queueBind(queueName, EXCHANGE_TOPIC_LOGS, key);
        }
